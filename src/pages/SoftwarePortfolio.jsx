    ...
    <div className="sw-shell">
      <header className="sw-nav glass">
        ...
        <div className="sw-nav-actions">
          <button
            className="wes-nav-button"
            onClick={() => window.dispatchEvent(new Event("open-wesmind"))}
            aria-label="Open WesMind"
          >
            <span className="wes-nav-mark">
              <b>W</b>
              <Sparkles />
            </span>
            <span>WesMind</span>
        ...
        <section id="home" className="sw-hero sw-section">
          <motion.div className="hero-copy" {...reveal}>
            ...
            <p className="hero-lead">
              ...
              both frontend and backend technologies, with writing clean and
              scalable code.
            </p>
        ...
        <section id="about" className="sw-section sw-block">
          <motion.div {...reveal}>
            ...
            <p className="section-copy">
              ...
              ideas into real world solutions. I enjoy understanding how systems
              work, solving real world problems, and continuously expanding my
        ...
        <section id="certifications" className="sw-section sw-block">
          <motion.div {...reveal}>
            ...
            <p className="section-copy">
              ...
              strengthen my skills as a software engineer.
            </p>
          </motion.div>
          <CertificationVault />
        </section>
