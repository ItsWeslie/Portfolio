...
export default function CertificationVault({certifications=localCertifications}){
  ...
  return <div className="cert-vault">
    ...
    <div className="cert-api-note"><code>GET /api/certifications?page={safePage-1}&amp;size={PAGE_SIZE}</code><span>frontend-ready for future Spring Boot pagination</span></div>
